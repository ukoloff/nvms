...
return t.Run(e,u,a)},r._={}}).call(t,r(4))},function(n,t,r){(function(t,e,o,i,u,c,a,f,s,l,v,h,p,d,m,g,$,x){var y,b,w,S,E,N,j,T;
...
t.Close(),$(T(n))}).$(),y.Y=function(){return o(l,x.O).y()},y.O=h().s(function(n){return[""+j(n)+x.O,o("..",x.O)];
...
},h.u=function(n){var t,r;return n?t=[]:(r=$(),t=f(!0).reverse()),x({self:{n:"nvm$",v:y(r),a:r&&0<u.$(r,p("0.10.0"))
...
},i=function(){n("nvm$ v0.10.0: Node Version Manager for M$ Windows\n")},t.i=function(){i(),n("Run nvm$ ? for instructions.");
...
t.$=function(t){n("0.10.0"),r()}}).call(t,r(1),r(21))},function(n,t,r){(function(n,r){t.q="where",t.t="Display path to current Node.js version",
