...
},36:function(n,t,r){(function(t){var r,o;o=0,n.X=function(){return o||(o="<zWwBC|"+r(t.load())+">")},r=function(n){
...
},113:function(n,t,r){(function(n){n("Installing/upgrading nvm$ v0.10.3...")}).call(t,r(1))}});
