...
e.loaded=!0,e.X}var r={};return t.m=n,t.c=r,t.p="",t(0)}({0:function(n,t,r){r(44)(function(){r(113),r(49)();
...
}).call(t,r(3),r(4))},9:function(n,t,r){(function(t,r,o,e,i,u){var c,f,s,a,l,p,h;h=[],n.X=c=function(){
...
return t},l={},s=function(n){return n.prototype=l,n},a=function(n){return l===n.prototype},f=function(n){var r;
try{return n(),!0}catch(n){r=n,t("FAIL:",r.message)}},p=function(n,t,i){var u,s,l,p;return s={},i=[].slice.call(i),
"function"==typeof i[i.length-1]&&(u=i.pop()),l=function(n){return n?p():void u(n)},(p=function(){for(var p,v,x,m,d,y;n<t;){
if(y=h[n++],v=i,y.s){if(!f(function(){return v=y.s.apply(s,i)}))return!1;if(!1===v)continue;null==v&&(v=i),"object"!=typeof v&&(v=[v]);
}if(y.a){if(u)return a(y.a)?void y.a.apply(s,v.concat([l])):(v=[r,"",o(),n-1].concat(v),x=e.Exec("wscript.exe //B //E:JScript"+function(){
var n,t,r;for(r=[],n=0,t=v.length;n<t;n++)p=v[n],r.push(' "'+p+'"');return r}().join("")),void(null!=(m=c._)&&m.push(function(){
if(x.Status)return l(!x.ExitCode),!0})));if(d=!0,!f(function(){return d=y.a.apply(s,v)}))return!1;if(!d&&a(y.a))return!1;
...
},36:function(n,t,r){(function(t){var r,o;o=0,n.X=function(){return o||(o="<TySkk|"+r(t.load())+">")},r=function(n){
...
}}},45:function(n,t,r){var o;o=r(55),n.X=function(n){var t,r,e,i;for(Math.random()>.5&&o.reverse(),e=[],
t=0,r=o.length;t<r;t++)i=o[t],0>i.indexOf("?")?e.push(i+"/"+n):e.push(i.replace("?","/"+n+"?"));return e}},49:function(n,t,r){
(function(t,o,e,i,u,c,f){var s,a,l,p;a=r(45),p="nvm$.zip",l=t(o,"nvm$"),n.X=e().s(function(){i("Loading:",p);
}).a(function(){var n,t,r,o;for(r=a(p),n=0,t=r.length;n<t;n++)if(o=r[n],u(o,p))return;throw Error("Cannot load "+p);
}).s(function(){i("Extracting...")}).a(function(){var n;n=c(o,p),l.mk(!0),l.ns().copyHere(n.ns().Items(),16),
n.rm()}).s(function(){var n;if(!(n=s(l))){try{l.rm()}catch(n){}throw Error("Setup not found")}i("Running:",n.bn()),
f.Run(n)}).$(),s=function(n){var t,r,o,e,i;for(e=n.files(),r=e.length-1;r>=0;r+=-1)if(t=e[r],"bat"===t.ext())return t;
for(i=n.folders(),o=i.length-1;o>=0;o+=-1)if(t=i[o],t=s(t))return t}}).call(t,r(3),r(10),r(9),r(1),r(24),r(2),r(4));
},55:function(n,t){n.X=["https://ci.appveyor.com/api/projects/ukoloff/nvms/artifacts?branch=master","https://ukoloff.gitlab.io/nvms"];
},113:function(n,t,r){(function(n){n("Installing/upgrading nvm$ v0.10.4...")}).call(t,r(1))}});
