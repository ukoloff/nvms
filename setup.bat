...
return r||(r="<XTEtV|"+e(t.load())+">")},e=function(n){var t,e,r;for(t=1,e=0,r=n.length;r--;)t=(t+n.charCodeAt(r))%65521,
...
u(f,"taskbarpin")}).call(t,e(4),e(8))},function(n,t,e){(function(n,t,r,o,i,c,u,f){var a,l;n("Installing nvm$ v0.10.0 to:",t),
