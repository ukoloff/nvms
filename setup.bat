...
}).call(t,e(3),e(7))},function(n,t,e){n.X=function(n){var t;try{n()}catch(n){if(t=n,!t.message)throw t;e(2)("ERROR:",t.message);
}}},function(n,t,e){(function(t,e,r,o){var i,u;n.X=u=function(n){var u,c;return n=t(e,n).mk(),r(n,"nvm$.bat").save('@"%~dp0..\\cli.bat" %*\n'),
(c=r(e,i)).y()&&!(u=r(n,"openssl.exe")).y()&&c.cp(u),o(n)},u.O=i="openssl-cli.exe"}).call(t,e(1),e(5),e(3),e(28))},function(n,t,e){
(function(t){n.X=function(n){null==n&&(n=0),t.Quit(n)}}).call(t,e(7))},function(n,t,e){(function(t,e){var r,o,i;i="Path",o=t.Environment("User"),
r=new Function("o,k,v","o(k)=v"),n.X=function(n){var t,u,c;if(u=o(i),t=""+e.$,c=function(){var n,e,r,o;for(r=u.split(";"),o=[],
n=0,e=r.length;n<e;n++)c=r[n],c!==t&&o.push(c);return o}(),n&&c.unshift(t),c=c.join(";"),c!==u)return r(o,i,c)}}).call(t,e(8),e(9));
},,function(n,t,e){(function(t,e,r,o){var i,u;n.X=function(n){var i,c,a,f;if((a=t(n,"node.exe")).y()&&!(i=t(n,"nodew.exe")).y()){
f=e(),f.LoadFromFile(a);try{u(f)}catch(n){r("Invalid executable:",a),c=!0}return c||(r("Generating:",i),f.Write(o.dec("02")),f.SaveToFile(i)),
f.Close()}},u=function(n){var t,e,r;return e=function(t){return o.i(n.Read(t))},i(23117===e(2)),n.Position=60,t=e(4),i(t<n.size),
...
r.Sleep(3e3);try{o(n.load()).rm(!0)}catch(n){}p.rm(!0),i()},s=function(){var n,r;r=o(u,l+"-"+c(8)).mk(!0),t.cp(n=e(r,t.bn())),e(""+n+f).save(p),
a(0,n)}}).call(t,e(22),e(3),e(7),e(1),e(25),e(15),e(29),e(11))}]);
